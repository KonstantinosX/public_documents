...
\moveleft.5\hoffset\centerline{3220 A.V. Williams Bldg} % Your address
...
Worked with a team of experienced research scientists on problems revolving around domain ontologies, knowledge graph data management, and retrieval. \\
\textit{Technical Skills}: Java, Spark MLlib
